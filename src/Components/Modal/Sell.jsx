...
const Sell = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ Instantly update context — no need to refetch Firestore
      setItems((prev) => (prev ? [...prev, newProduct] : [newProduct]));
                ...
                {image ? (
                  ...
                  <div className="relative h-40 sm:h-60 w-full border-2 border-black rounded-md">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
                      ...
                      <p className="text-center text-sm pt-2 font-medium">
